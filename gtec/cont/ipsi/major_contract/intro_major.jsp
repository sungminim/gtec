...
<div id="contents">
    ...
    <article>
        ...
        <div class="intro_major defaultWrap">
            ...
            <p class="txt">
                국가 &middot; 지방자치단체 &middot; 산업체 등이 <span class="pointGreen">소속 직원의 재교육</span>, 직무능력 향상, 전직(轉職) 교육을 위하여 <span class="pointGreen">경비의 전부 또는 일부(50% 이상)</span>를 부담하면서 교육을 의뢰하는 경우의
                학과 형태(모집정원에 제한 없음)
            </p>

            <b class="txtSt1">채용조건형</b>
            <p class="txt">
                국가 &middot; 지방자치단체 &middot; 산업체 등이 <span class="pointGreen">채용을 조건으로 학자금 지원계약(등록금의 100% 산업체 부담)을 체결</span>하고, 특별한 교육과정을 운영하는 경우의 학과 형태(모집정원은 전체 입학생 수  또는 입학정원의 10% 이내)
            </p>
