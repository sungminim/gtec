...
<div id="contents">
    ...
    <article>
        ...
        <div class="eduRequest defaultWrap">
            ...
            <ul class="list_dotGreen">
                ...
                <li>주2) 관계법령 등에 따라 이미 설치되어 있는 학과 &middot; 학부나 유사한 학과 &middot; 학부를 우선 활용하되, 필요시 새로운 학과 설치 가능</li>
                <li>주3) 채용조건형 계약학과는 대학에서 학생을 모집 &middot; 선발하되, 산업체 희망 시 산업체 관계자의 면접참여를 보장</li>
            </ul>
            ...
            <ul class="list_dotGreen">
                <li>
                    조사내용 : 산업체 10개월 이상 재직자 중 본교 정규학위 취득과정 교육의뢰 &middot; 개설 희망 수요조사
                ...
                <li>수요조사 결과 반영
                    <ul class="list_hyphen">
                        ...
                        <li>산업체와 본교 간 계약학과 설치 &middot; 운영을 위한 계약 체결
