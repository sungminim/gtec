        ...
        <article>
            ...
            <div class="office_info deptWrap">
				...
				<ul class="list_icoInfo list_range">
					<li class="location">
						<div class="wrap">
							<div class="innerWrap"><b class="info_tit">사무실</b> 창조V관 421호(행정), 104호(실습)</div>
						</div>
					</li>
					<li class="fax">
						<div class="wrap">
							<div class="innerWrap">
								<b class="info_tit">팩스번호</b> 031-496-9135
							</div>
						</div>
					</li>
					<li class="tel">
						<div class="wrap">
							<div class="innerWrap"><b class="info_tit">전화번호</b>031-496-4637(행정), 4615(실습)</div>
						</div>
					</li>
					<li class="etc">
						<div class="wrap">
							<div class="innerWrap">
								...
								운영시간 09:20 ~ 18:00(학기중) / 점심시간 12:00 ~ 13:00
