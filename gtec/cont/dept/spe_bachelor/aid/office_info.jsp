        ...
        <article>
            ...
            <div class="office_info deptWrap">
				...
				<ul class="list_icoInfo list_range">
					<li class="location">
						<div class="wrap">
							<div class="innerWrap"><b class="info_tit">사무실</b> 창조E관 206호</div>
						</div>
					</li>
					<li class="fax">
						<div class="wrap">
							<div class="innerWrap">
								<b class="info_tit">팩스번호</b> 031-431-9543
							</div>
						</div>
					</li>
					<li class="tel">
						<div class="wrap">
							<div class="innerWrap"><b class="info_tit">전화번호</b><a href="tel:031-496-4640"> 031-496-4640</a></div>
						</div>
					</li>
					<li class="etc">
						<div class="wrap">
