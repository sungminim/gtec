...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept10_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept10_thumb_major.jpg" alt="실내디자인학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Interior Design</span>
			<strong class="tit">
				실내디자인학부
			</strong>
			<p class="txt">
				특성화된 전공에서 창의적 능력, 미적 감각, 실무현장 중심의 전문적 이론과 기술을 교육하여 실내디자인 분야에 최적화된 인재를 양성합니다.
			</p>
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img01.jpg);"><!--20.09.14수정 -->
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept10_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img03.jpg);">
						<span>취업정보</span>
					</a>
				</li>
			</ul>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept10_bnr_img01.jpg);">
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept10_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
