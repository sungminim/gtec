...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept06_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept06_thumb_major.jpg" alt="컴퓨터정보학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Computer Information</span>
			<strong class="tit">
				컴퓨터정보학부
			</strong>
			<p class="txt">
				4차 산업혁명의 중심! 미래사회를 선도하는 정보기술 IT 전문가 양성학부
			</p>
			<a href="#none" class="btn_deptHome">컴퓨터소프트웨어전공</a>
			<a href="#none" class="btn_deptHome">스마트소프트웨어전공</a>
		</div>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept06_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept06_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
