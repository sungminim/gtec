...
<link rel="stylesheet" type="text/css" href="/gtec/type/DEPT_B/css/layout.css" /><!-- 개별 -->
<link rel="stylesheet" type="text/css" href="/gtec/type/DEPT_B/css/main.css" /><!-- main -->
...
<script type="text/javascript" src="/gtec/type/DEPT_B/js/layout.js"></script><!-- 개별 -->
<script type="text/javascript" src="/gtec/type/DEPT_B/js/main.js"></script><!-- main -->
...
<div id="header">
	<header>
		<h1 class="logo">
			<a href="#none">
				<img src="/gtec/type/DEPT_B/img/layout/logo.png" alt="경기과학기술대학교 미디어디자인과" />
			</a>
		</h1>
        ...
        <h1 class="mLogo">
            <a href="#none">
                <img src="/gtec/type/DEPT_C/img/layout/logo.png" alt="경기과학기술대학교 미디어디자인과" />
            </a>
        </h1>
