...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept05_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept01_thumb_major.jpg" alt="스마트전자&middot;통신학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Smart Electronics & Commuication Engineering</span>
			<strong class="tit">
				스마트전자&middot;통신학부
			</strong>
			<p class="txt">
				4차 산업혁명시대 스마트 전자∙통신 첨단산업 분야의 창의적 개발 인재 양성
			</p>
			<a href="#none" class="btn_deptHome" style="width:280px;">반도체디자인&middot;IoT전자전공</a>
			<a href="#none" class="btn_deptHome" style="width:280px;">정보통신&middot;무선통신전공</a>
		</div>
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img01.jpg);">
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept05_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept05_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
