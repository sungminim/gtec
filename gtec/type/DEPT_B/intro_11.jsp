...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept11_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept11_thumb_major.jpg" alt="방송음향영상학부 방송음향기술전공 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">
				Div. of Sound Technology & Media Art<br />
				Broadcasting Sound Media Technology
			</span>
			<strong class="tit">
				방송음향영상학부<br />
				방송음향기술전공
			...
			<p class="txt" style="margin-bottom:60px;">
				음향콘텐츠 제작 및 방송시스템디자인이 가능한 음향 전문인을 양성
			</p>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept11_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept11_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
