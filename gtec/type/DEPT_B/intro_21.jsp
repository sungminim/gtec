...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept21_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept21_thumb_major.jpg" alt="스포츠지도과 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Dept. of Sports Training</span>
			<strong class="tit">
				스포츠지도과
			</strong>
			<p class="txt">
				전문대학 체육계열 학과 평가 A+의 검증된 스포츠 전문 인력, 미래를 위한 믿음직한 동반자
			</p>
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="https://dept.daelim.ac.kr/csr/eduPurps.do?dmmy=1&lid=DlucCurlmPurps&pid=3000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img01.jpg);">
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="https://dept.daelim.ac.kr/csr/majorFclty.do?dmmy=1&lid=DlucMajorFclty&pid=1000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept21_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
					<a href="https://dept.daelim.ac.kr/csr/emplymtCertct.do?dmmy=1&lid=DlucEmplymtCertct&pid=4000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img03.jpg);">
						<span>취업정보</span>
					</a>
				</li>
			</ul>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept21bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
