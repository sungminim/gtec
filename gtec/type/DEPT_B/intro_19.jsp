...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept19_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept19_thumb_major.jpg" alt="비서&middot;사무행정학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Secretary Office Administration</span>
			<strong class="tit">
				비서&middot;사무행정학부
			</strong>
			<p class="txt">
				현장실무와 문제해결 능력을 갖춘 전문비서 및 사무전문가 양성
			</p>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept19_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept19_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
