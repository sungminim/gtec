...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept13_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept13_thumb_major.jpg" alt="보건의료기기과 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Dept. of Biomedical Engineering</span>
			<strong class="tit">
				보건의료기기과
			</strong>
			<p class="txt">
				첨단 의학 공학 융합 교육의 메카<br />
				대림대학교 보건의료기기과
			</p>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept13_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept13_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
