...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept01_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept01_thumb_major.jpg" alt="기계과 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Dept. of Mechanical Engineering</span>
			<strong class="tit">
				기계과
			</strong>
			<p class="txt">
				설계, 생산, 연구개발, 관리업무 전문기술인 양성
			</p>
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="https://dept.daelim.ac.kr/mac/eduPurps.do?dmmy=1&lid=DlucCurlmPurps&pid=3000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img01.jpg);">
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="https://dept.daelim.ac.kr/mac/majorFclty.do?dmmy=1&lid=DlucMajorFclty&pid=1000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept01_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
					<a href="https://dept.daelim.ac.kr/mac/jobCondition.do?dmmy=1&lid=DlucJobCondition&pid=4000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img03.jpg);">
						<span>취업정보</span>
					</a>
				</li>
			</ul>
