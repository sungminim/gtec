...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bg_body.jpg)">
	<header>
		<h1>
		...
		<span class="util">
			<a href="https://www.daelim.ac.kr/hme/index.do" class="btn_home">대림대학교</a>
		</span>
	</header>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept07_thumb_major.jpg" alt="스마트팩토리학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Smart Factory Engineering</span>
			<strong class="tit">
				스마트팩토리학부
			</strong>
			<p class="txt">
				스마트팩토리의 주역을 양성하는 곳<br />
				4차산업혁명의 꿈을 완성하는 곳
			</p>
			<a href="#none" class="btn_deptHome" style="width:215px;">반도체장비전공</a><!-- 200914수정 -->
			<a href="#none" class="btn_deptHome" style="width:215px;">메카트로닉스전공</a><!-- 200914수정 -->
			<a href="#none" class="btn_deptHome" style="width:215px;">스마트자동화전공</a><!-- 200914수정 -->
		</div>
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img01.jpg);">
						<span>반도체장비</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img02.jpg);">
						<span>메카트로닉스</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img03.jpg);">
						<span>스마트자동화</span>
					</a>
				</li>
			</ul>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img01.jpg);">
						<span>반도체장비</span>
					</a>
				</li>
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img02.jpg);">
						<span>메카트로닉스</span>
					</a>
				</li>
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept07_bnr_img03.jpg);">
						<span>스마트자동화</span>
					</a>
				</li>
			</ul>
