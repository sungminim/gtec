...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept20_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept20_thumb_major.jpg" alt="유아교육과 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Dept. of Early Childhood Education</span>
			<strong class="tit">
				유아교육과
			</strong>
			<p class="txt">
		...
		<div class="ct_bnr">
			<ul>
				<li>
					<a href="https://dept.daelim.ac.kr/chi/eduPurps.do?dmmy=1&lid=DlucCurlmPurps&pid=3000000" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept_bnr_img01.jpg);">
						<span>교육과정</span>
					</a>
				</li>
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept20_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept20_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
