...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept14_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept14_thumb_major.jpg" alt="경영학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Business Administration</span>
			<strong class="tit">
				경영학부
			</strong>
			<p class="txt">
				경영전공 및 세무회계전공으로 세분화하여 각 진출분야에 특화된 인재를 양성
			</p>
			<a href="#none" class="btn_deptHome">세무회계전공</a>
			<a href="#none" class="btn_deptHome">경영지원전공</a>
		</div>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept14_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept14_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
