...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept24_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept24_thumb_major.jpg" alt="호텔조리&middot;제과학부 제과제빵커피전공 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">
				Div. of Hotel Culinary, Baking and Pastry arts<br />
				Baking and Pastry arts, Coffee
			</span>
			<strong class="tit">
				호텔조리&middot;제과학부
				제과제빵커피전공
			...
			<p class="txt">
				실무중심의 교육을 통해 베이커리 카페산업의 고급기술인력 양성
			</p>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept24_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept24_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
