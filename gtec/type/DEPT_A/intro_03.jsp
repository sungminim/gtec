...
<div id="introIndex" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept03_bg_body.jpg)">
	<header>
		<h1>
	...
	<article id="contents">
		...
		<div class="ct_major">
			...
			<div class="typeImg" style="display:none;">
				<a href="#none">
					<img src="/daelim/type/DEPT_A/img/intro/dept03_thumb_major.jpg" alt="건축학부 대표이미지" />
				</a>
			</div>
			<!-- //이미지일 경우 -->
		...
		<div class="major_tit">
			<span class="tit_s">Div. of Architecture</span>
			<strong class="tit">
				건축학부
			</strong>
			<p class="txt">
				인간의 다양한 삶과 생활을 수용할 수 있는 건축공간을 계획하고 창조하는 전문인 양성
			</p>
		...
		<div class="ct_bnr">
			<ul>
				...
				<li>
					<a href="#none" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept03_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
		...
		<div class="ct_bnr" style="display:none;">
			<ul><!-- data-src에 유튜브 파일명 입력 -->
				...
				<li>
					<a href="javascript:void(0);" data-src="B6eZCkfz_tw" class="btn_play" style="background-image:url(/daelim/type/DEPT_A/img/intro/dept03_bnr_img02.jpg);">
						<span>학과시설</span>
					</a>
				</li>
				<li>
