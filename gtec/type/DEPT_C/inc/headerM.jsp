    ...
    <link rel="stylesheet" type="text/css" href="/gtec/type/DEPT_C/css/layout.css" /><!-- 개별 -->
    <link rel="stylesheet" type="text/css" href="/gtec/type/DEPT_C/css/main.css" /><!-- 메인 -->
    ...
    <script type="text/javascript" src="/gtec/type/DEPT_C/js/layout.js"></script><!-- 개별 -->
    </head>
    ...
    <div id="header">
        <header>
            <h1 class="logo">
                <a href="#none">
                    <img src="/gtec/type/DEPT_C/img/layout/logo.png" alt="경기과학기술대 스마트경영학과" />
                </a>
            </h1>
