...
<link rel="stylesheet" type="text/css" href="/gtec/type/ENG_A/css/main.css" /><!-- main -->
...
<script type="text/javascript" src="/gtec/type/ENG_A/js/main.js"></script><!-- main -->

</head>

<body id="verEng" class="typeMain"><!-- 메인:typeMain / 서브:typeSub -->
