...
<body class="typeSSO"><!-- 메인:typeMain / 서브:typeSub -->
...
<!-- header  -->
<div class="topGreenLine">
    <div class="area">
        <h1 class="logo"><a href="#none">경기과학기술대학교</a></h1>

        <div class="util">
            <a href="#none">입학홈페이지</a>
            <a href="#none">대학홈페이지</a>
            <a href="#none">종합정보시스템</a>
        </div>
    </div>
</div>
