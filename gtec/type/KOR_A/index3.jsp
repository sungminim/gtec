    ...
    <div id="contents">
        ...
        <!-- 21-01-06 스크립트 추가 -->
        <style>
            .mNoticeRolling .sliderArea .noticeSlider .item {width:auto !important;height:50px;}
        </style>
        <script>
            $(function(){
                Main2.Init();
        ...
        <div class="mNoticeRolling">
            <div class="sliderArea">
                ...
                <div class="noticeSlider">
                    ...
                    <a href="#none" class="item">1</a>
                    <a href="#none" class="item">2020학년도 스쿨버스 등 · 하교 코스 배차 시간 및 버스카드 발급 안내</a>
                    <a href="#none" class="item">2020학년도 대학생 창업아이디어 경진대회 참가결과 현황</a>
                    <a href="#none" class="item">test</a>
                    <a href="#none" class="item">2020학년도 스쿨버스 등 · 하교 코스 배차 시간 및 버스카드 발급 안내</a>
                    <a href="#none" class="item">2020학년도 대학생 창업아이디어 경진대회 참가결과 현황</a>
                    <a href="#none" class="item">2020학년도 1학기 교원(전임, 겸임) 초빙 공고2020학년도 1학기 교원(전임, 겸임) 초빙 공고2020학년도 1학기
                        교원(전임, 겸임) 초빙 공고2020학년도 1학기 교원(전임, 겸임) 초빙 공고</a>
                    <a href="#none" class="item">2020학년도 스쿨버스 등 · 하교 코스 배차 시간 및 버스카드 발급 안내</a>
                    <a href="#none" class="item">2020학년도 대학생 창업아이디어 경진대회 참가결과 현황</a>
