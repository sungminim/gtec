<%@ page contentType="text/html;charset=utf-8" pageEncoding="UTF-8"%>
			...
			<div class="board_area">
				...
				<!-- 리스트(기본) -->
				<div class="lineList_ul typeQna typeSortTop"><!-- 구분(분류)가 상단에 있을때 -->
					<!--
						### ul에 추가되는 class ###
						*카테고리 없는 리스트 : noCateg
					 -->
					<ul class="noCateg">
						...
						<!--
						 ...
						 <li class="typeNoti typeAns typeFile typeCommen">
							<span class="mark_num">
 						...
 						<li class="typeNoti typeAns typeFile typeIco typeCommen">
							<span class="mark_num">
								<span class="mark_noti">공지</span>
							</span>
 						...
 						<li class="typeNoti typeAns typeFile">
							<span class="mark_num">
								<span>8</span>
							</span>
							<!--<span class="mark_categ">재외국민</span>-->
 							...
 							<div class="txtAdd">
 								<span class="answer">
 									<span class="mark_ingReady">대기</span>
 								</span>
 								<span class="hasArea">
 									<a href="#none" class="hasfile">첨부파일</a>
 									<!--<span class="hasfileNum">5</span>-->
 						...
 						<li class="typeAns typeFile typeIco">
							<span class="mark_num">
								<span>7</span>
							</span>
							<!--<span class="mark_categ">편입학</span>-->
 							...
 							<div class="txtAdd">
 								<span class="answer"><span class="mark_ingReady">대기</span></span>
 								<span class="hasArea">
 									<a href="#none" class="hasfile">첨부파일</a>
 								</span>
 							</div>
 						...
 						<li class="typeAns">
							...
							<!--<span class="mark_categ">수시모집</span>-->
 							...
 							<div class="txtAdd">
 								<span class="answer"><span class="mark_ingEnd">완료</span></span>
 								<!-- <span class="hasArea"></span> -->
 							</div>
 							<div class="txtInfo">
 						...
 						<li class="typeAns typeFile typeIco typeCommen">
							<span class="mark_num">
								<span>3</span>
							</span>
							<!--<span class="mark_categ">수시모집</span>-->
