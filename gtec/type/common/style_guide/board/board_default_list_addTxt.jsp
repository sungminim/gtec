						...
						<!--
						 ...
						 <li class="typeNoti typeFile typeCommen">
							...
							<span class="mark_categ">수시모집</span>
 							<div class="txtL txtP"><!-- 내용이 추가되면 txtP 클래스 추가 -->
 								<a href="#none">강의경력 증명서를 발급 받고 싶습니다</a>
 								<span class="info_comment"><em>댓글</em>[15]</span>
								<p>강의경력 증명서를 발급 받고 싶습니다강의경력 증명서를 발급 받고 싶습니다강의경력 증명서를 발급 받고 싶습니다강의경력 증명서를 발급 받고 싶습니다강의경력 증명서를 발급 받고 싶습니다</p>
 							</div>
 							<div class="txtAdd">
 						...
 						<li>
							...
							<span class="mark_categ">수시모집</span>
 							<div class="txtL txtP"><!-- 내용이 추가되면 txtP 클래스 추가 -->
								...
								<p>강의경력 증명서를 발급 받고 싶습니다강의경력 증명서를</p>
 							</div>
 							<div class="txtAdd">
