		...
		<article>
            ...
            <div class="siteMap">
                ...
                <div class="group">
                    ...
                    <ul class="depth1">
                        <li class="full"><a href="#none">입학안내 사이트로 이동</a></li>
                    </ul>
                </div>
                <div class="group">
                ...
                <div class="group">
                    ...
                    <ul class="depth1">
                        <li class="full"><a href="#none">취업정보 이동</a></li>
                    </ul>    
                </div>
